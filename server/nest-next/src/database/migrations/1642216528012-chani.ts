...
export class chani1642216528012 implements MigrationInterface {
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "list" ADD CONSTRAINT "list_corp_fk" FOREIGN KEY ("corp") REFERENCES "corp"("stock_code") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "list" DROP CONSTRAINT "list_corp_fk"`);
